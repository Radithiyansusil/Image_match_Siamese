...
for i in range(total_count):
  image_1=show_image_aws(image_paths_1[i]) #change the function according to where you get data
  image_2=show_image_aws(image_paths_2[i]) #change the function according to where you get data
